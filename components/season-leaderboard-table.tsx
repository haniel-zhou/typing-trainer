    ...
    <Card className="overflow-hidden">
      ...
      <CardContent className="space-y-3">
        {entries.map((entry, index) => (
          <div
            key={entry.id}
            className="grid gap-3 rounded-[24px] border border-sky-100 bg-white/75 p-4 md:grid-cols-[76px_minmax(0,1fr)_120px_120px_120px]"
          >
            ...
            <div>
              ...
              <div className="mt-2 font-display text-2xl text-sky-950">{entry.seasonPoints}</div>
            </div>
            <div>
              <div className="flex items-center gap-1 text-xs text-sky-600/70">
              ...
              <div className="mt-2 font-display text-2xl text-sky-950">{entry.bestWpm}</div>
            </div>
            <div>
              <div className="flex items-center gap-1 text-xs text-sky-600/70">
              ...
              <div className="mt-2 font-display text-2xl text-sky-950">{entry.totalSessions}</div>
            </div>
          </div>
        ))}
      </CardContent>
